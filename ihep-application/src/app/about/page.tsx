    ...
    <main className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-lime-50">
      <div className="container mx-auto max-w-5xl px-4 py-16 space-y-10">
        <header className="space-y-3 text-center">
          <p className="text-sm uppercase tracking-wide text-emerald-700">About IHEP</p>
          <h1 className="text-3xl md:text-4xl font-bold text-green-900">Integrated Health Empowerment Program</h1>
          ...
          {[
            {
              ...
              desc: 'Health, financial, social, and care twins give a 360° view to personalize plans.',
            },
            {
        ...
        <section className="rounded-2xl border border-green-100 bg-white p-6 shadow-sm">
          <h2 className="text-xl font-semibold text-green-800 mb-2">Talk with us</h2>
          <p className="text-gray-600 mb-4">
            Have questions about care pathways, security, or partnerships? Reach out and we will respond quickly.
          </p>
          <div className="flex flex-wrap gap-3">
            <a className="px-5 py-2 rounded-full bg-gradient-to-r from-green-700 to-emerald-600 text-white text-sm font-medium" href="mailto:support@ihep.app">
              support@ihep.app
            </a>
            <a className="px-5 py-2 rounded-full border border-green-700 text-green-800 text-sm font-medium hover:bg-green-50" href="/#contact">
              Contact form
            </a>
