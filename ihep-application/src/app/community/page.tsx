    ...
    <main className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-lime-50">
      <div className="container mx-auto max-w-5xl px-4 py-16 space-y-10">
        <header className="space-y-3 text-center">
          <p className="text-sm uppercase tracking-wide text-emerald-700">Community</p>
          <h1 className="text-3xl md:text-4xl font-bold text-green-900">Connect with peers and care allies</h1>
        ...
        <section className="rounded-2xl border border-green-100 bg-white p-6 shadow-sm">
          <h2 className="text-xl font-semibold text-green-800 mb-2">Join the community</h2>
